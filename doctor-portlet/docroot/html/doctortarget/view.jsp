				...
				<div class="ibox-content breadcrumbs2"
					...
					<div class="row-fluid p-t-xxs">
						...
						<div id="drop_down_organization"
							...
							<select data-toggle="tooltip" title="medical_procedure"
						...
						<div id="drop_down_organization"
							class="form-group pull-left span2" style="margin-left: 5px;">
							<select data-toggle="tooltip" title="ปี"
								class="input span12 m-b-n" id="year" name="year">
						...
						<div id="drop_down_organization"
							class="form-group pull-left span2" style="margin-left: 5px;">
							<select data-toggle="tooltip" title="เดือน"
								class="input span12 m-b-n" id="month" name="month">
				...
				<table class="table table-striped" id="table_doctor_target">
					...
					<tbody>
						<tr>
							...
							<td style="vertical-align: middle;">พญ. สาทิสรัตน์
								กิจปิลันธ์กรกุล</td>
						...
						<tr>
							...
							<td style="vertical-align: middle; text-align: center;"><i
								class="fa fa-cog font-gear popover-edit-del"
								data-trigger="focus" tabindex="1" data-html="true"
								data-toggle="popover" data-placement="top"
								data-content=" 
													<button class='btn btn-warning btn-xs btn-gear edit' data-target=#ModalEdit data-toggle='modal'>แก้ไข</button> 
													<button class='btn btn-danger btn-xs btn-gear del' data-target=#confrimModal data-toggle='modal' style='margin-left: 15px'>ลบ</button>">
				...
				<div class="row-fluid">
					<div class="span12 form-horizontal p-t-xxs">
						<div class="row-fluid p-t-xxs">
							...
							<div id="drop_down_organization"
								class="form-group pull-left span2" style="margin-left: 5px;">
								<select data-toggle="tooltip" title="ประเภท Case"
									class="input span12 m-b-n" id="case_category"
									name="case_category">
							...
							<div id="drop_down_organization"
								...
								<select data-toggle="tooltip" title="หัตถการ"
									class="input span12 m-b-n" id="from_medical_procedure"
									name="from_medical_procedure">
							...
							<div id="drop_down_organization"
								class="form-group pull-left span2" style="margin-left: 5px;">
								<select data-toggle="tooltip" title="ปี"
									class="input span12 m-b-n" id="from_year" name="from_year">
									<option selected value="">2017</option>
								</select>
							...
							<tbody>
								<tr class="tr-table-case">
									...
									<td style="vertical-align: middle;"><input type="text"
										value="1" class="input-edit-doctor-edu" style="width: 85%;" />
									</td>
									<td style="vertical-align: middle;"><input type="text"
										value="1" class="input-edit-doctor-edu" style="width: 85%;" />
						...
						<div class="modal-footer">
							<button class="btn btn-info" type="button"
								id="btn_submit_case_category">บันทึก</button>
							<button class="btn btn-info" type="button"
