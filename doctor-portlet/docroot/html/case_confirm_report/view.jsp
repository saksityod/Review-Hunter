		...
		<div class="span12">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<h5>รายงานการนัดเคสของแพทย์แต่ละท่าน</h5>
				</div>
				<!-- search -->
				<div class="ibox-content breadcrumbs2">
					<div class="row-fluid p-t-xxs">
						<div class="form-group span3">
							<label class="label-control" for="">ระบุช่วงเวลา(ล่วงหน้า)</label>
							<select data-toggle="tooltip" title="ระบุช่วงเวลา" class="input span12 m-b-n" id="time" name="time">
						...
						<div class="form-group span3">
							...
							<select data-toggle="tooltip" title="ชื่อแพทย์"
								class="input span12 m-b-n" id="doctor" name="doctor">
							</select>
						</div>
					</div>
					<div class="row-fluid p-t-xxs">
						<div class="form-group text-right span12">
