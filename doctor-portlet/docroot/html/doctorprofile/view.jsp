...
<div id="container1" >
				...
				<div class="row-fluid app_url_hidden" >
					...
					<div class="row-fluid p-t-xxs">
						...
						<div id="drop_down_organization" class="form-group pull-left span2" style="margin-left: 5px;">
							<select data-toggle="tooltip" title="หัตถการ" class="input span12 m-b-n" id="medical_procedure" name="search_org">
										...
										<tr>
											...
											<td style="vertical-align: middle; text-align:center;">
												<i class="fa fa-cog font-gear popover-edit-del" data-trigger="focus" tabindex="0" data-html="true" data-toggle="popover" 
													data-placement="top" 
													data-content=" 
													<button class='btn btn-warning btn-xs btn-gear edit' data-target=#ModalEditDetail data-toggle='modal'>แก้ไข</button> 
	...
	<div aria-hidden="true" role="dialog" class="modal inmodal  large" tabindex="-1" id="ModalEditDetail"
					...
					<div class="row-fluid">
	                	<div class="span12 form-horizontal p-t-xxs">
	                		<div class="form-group p-xxs">
								<label class="control-label">ชื่อแพทย์:<span class='redFont'>*</span></label>
								<div class="controls">
									<input type="text" class="form-control input-sm span12"  placeholder="" name="from_doctor_name" id="from_doctor_name">
								</div>
							</div>
							<div class="form-group p-xxs">
								<label class="control-label">เพศ:<span class='redFont '>*</span></label>
								<div class="controls">
									<select class="input span12 m-b-n" style="width: 70px" name="from_doctor_sex" id="from_doctor_sex">
										<option>ชาย</option>
										<option>หญิง</option>
									</select>
								</div>
							</div>
							<div class="form-group p-xxs" style="margin-top: 15px; margin-bottom: 15px;">
								<label class="control-label">หัตถการ:</label>
								<div class="controls">
									<select id="from_medical_procedure" name="from_medical_procedure" multiple="multiple">
									    <option value="ศัลยกรรมตา">ศัลยกรรมตา</option>
									 	<option value="ศัลยกรรมตา">ศัลยกรรมตา</option>
									 	<option value="ศัลยกรรมตา">ศัลยกรรมตา</option>
									 	<option value="ศัลยกรรมตา">ศัลยกรรมตา</option>
									 	<option value="ศัลยกรรมตา">ศัลยกรรมตา</option>
									...
									<label style="margin-top: 10px; margin-bottom: 10px; width: 70px; display: inline; margin-left: 20px">
										<input type="checkbox" id="from_active" name="from_active"/> Active
									</label>
								</div>
							</div>
							...
							<div class="form-group p-xxs">
								...
								<div class="controls">
									<textarea rows="4" cols="50" class="form-control input-sm span12" name="from_doctor_exp" id="from_doctor_exp">
									</textarea>
								</div>
							</div>
							<strong style="font-size: 15px">การศึกษา</strong>
							<br/>
							<div style="margin-left: 20px; padding-top: 0.5rem; padding-bottom: 0.5rem;">
								<button class="btn btn-success btn-add-edu" type="button">เพิ่ม</button>
								<button class="btn btn-success btn-submit-edu" type="button" style="display: none;">บันทึก</button>
								<button class="btn btn-warning btn-edit-edu" type="button">แก้ไข</button>
								<button class="btn btn-warning btn-submit-edit-edu" type="button" style="display: none;">บันทึก</button>
								<button class="btn btn-danger" type="button">ลบ</button>
								<div style="float: right;">
									<button class="btn btn-danger btn-cancel-add-edu" type="button" style="display: none;">ยกเลิก</button>
									<button class="btn btn-danger btn-cancel-edit-edu" type="button" style="display: none;">ยกเลิก</button>
								</div>
							</div>
							...
							<table class="table table-striped">
									<thead>
										<tr>
											...
											<th style='width: auto text-align:center;'><strong>สถาบันการศึกษา</strong></th>
											<th style='width: auto'><strong>ระดับการศึกษา</strong></th>
									...
									<tbody>
										<tr >
											...
											<td style="vertical-align: middle;">
												<span class="span-text-doctor-edu">มหาวิทยาลัยขอนแก่น</span>
												<input type="text" value="มหาวิทยาลัยขอนแก่น" class="input-edit-doctor-edu" style="width: 85%; display: none;"/>
											</td>
											<td style="vertical-align: middle;">
												<span class="span-text-doctor-edu">ปริญญาตรี</span>
												<input type="text" value="ปริญญาตรี" class="input-edit-doctor-edu" style="width: 85%; display: none;"/>
											</td>
											<td style="vertical-align: middle;">
												<span class="span-text-doctor-edu">แพทย์ศาสตร์บัณฑิตตา</span>
												<input type="text" value="แพทย์ศาสตร์บัณฑิตตา" class="input-edit-doctor-edu" style="width: 85%; display: none;"/>
											</td>
										...
										<tr class="add-edu-doctor-detail" style="display: none;">
											<td style="vertical-align: middle;">
											</td>
											<td style="vertical-align: middle;">
								...
								<strong style="font-size: 15px;">ประสบการณ์การทำงาน</strong>
							<br/>
							<div style="margin-left: 20px; padding-top: 0.5rem; padding-bottom: 0.5rem;">
								<button class="btn btn-success btn-add-exp" type="button">เพิ่ม</button>
								<button class="btn btn-success btn-submit-exp" type="button" style="display: none;">บันทึก</button>
								<button class="btn btn-warning btn-edit-exp" type="button">แก้ไข</button>
								<button class="btn btn-warning btn-submit-edit-exp" type="button" style="display: none;">บันทึก</button>
								<button class="btn btn-danger" type="button">ลบ</button>
								<div style="float: right;">
									<button class="btn btn-danger btn-cancel-add-exp" type="button" style="display: none;">ยกเลิก</button>
									<button class="btn btn-danger btn-cancel-edit-exp" type="button" style="display: none;">ยกเลิก</button>
								</div>
							</div>
							...
							<table class="table table-striped">
									<thead>
										<tr>
											<th style='width: auto text-align:center;'></th>
											<th style='width: auto text-align:center;'><strong>เริ่มปี</strong></th>
											<th style='width: auto'><strong>ถึงปี</strong></th>
									...
									<tbody>
										<tr >
											...
											<td style="vertical-align: middle;">
												<span class="span-text-doctor-exp" >2547</span>
												<input type="text" value="2547"  class="input-edit-doctor-exp" style="width: 85%; display: none;"/>
											</td>
											<td style="vertical-align: middle;">
												<span class="span-text-doctor-exp">2550</span>
												<input type="text" value="2550" class="input-edit-doctor-exp" style="width: 85%; display: none;"/>
											</td>
											<td style="vertical-align: middle;">
												<span class="span-text-doctor-exp">รมย์รวินท์คลินิก</span>
												<input type="text" value="รมย์รวินท์คลินิก" class="input-edit-doctor-exp" style="width: 85%; display: none;"/>
											</td>
				
										</tr>
										<tr class="add-exp-doctor-detail" style="display: none;">
											<td class='columnSearch' style="vertical-align: middle;">
											</td>
											<td class='columnSearch' style="vertical-align: middle;">
												<input type="text" value="" style="width: 85%;"/>
											</td>
	                	...
	                	<div class="modal-footer">
							...
							<button class="btn btn-info" type="button" id="btnLvSubmit">บันทึก และไปต่อ</button>
