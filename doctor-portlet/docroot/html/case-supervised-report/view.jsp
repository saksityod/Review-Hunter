			...
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content breadcrumbs2">
					<div class="row-fluid p-t-xxs">
						...
						<div class="form-group span3">
							<label class="label-control" for="">ชื่อผู้รับผิดชอบ</label>
							<select data-toggle="tooltip" title="ชื่อผู้รับผิดชอบ" class="input span12 m-b-n" id="user_id" name="user_id">
							</select>
						</div>
					</div>
					...
					<div class="row-fluid p-t-xxs">
						<div class="form-group span3">
							...
							<select data-toggle="tooltip" title="ประเภทเคส"
								class="input span12 m-b-n" id="case_type_id" name="case_type_id">
							</select>
						</div>
						<div class="form-group text-right span9">
