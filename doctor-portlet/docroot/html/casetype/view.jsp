					...
					<div class="row-fluid">
						<div id="width-100-persen" class="span9 m-b-xs">
							...
							<span class="pagination_top m-b-none pagination"
								...
								<ul class="pagination bootpag" id="case_type_pagination">
					...
					<div class="row-fluid">
						<div class="span12 form-horizontal p-t-xxs">
							...
							<div class="modal-footer">
								<button class="btn btn-success" type="button" id="btn_submit_add_case_type">Save</button>
				...
				<div class="modal-body">
					...
					<div class="row-fluid">
						<div class="span12 form-horizontal p-t-xxs">
							...
							<div class="modal-footer">
								<button class="btn btn-success" type="button" id="btn_submit_edit_case_type">Update</button>
								<button data-dismiss="modal" class="btn btn-danger btnCancle" type="button">Cancel</button>
							</div>
						</div>
					</div>
