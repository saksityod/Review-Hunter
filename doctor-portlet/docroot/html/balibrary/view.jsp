...
<div id="container1" >
				...
				<div class="row-fluid app_url_hidden" >
					...
					<div class="row-fluid p-t-xxs">
						...
						<div id="drop_down_organization" class="form-group pull-left span2" style="margin-left: 5px;">
							<select data-toggle="tooltip" title="หัตถการ" title="medical_procedure" class="input span12 m-b-n" id="medical_procedure" name="search_org">
								<option selected value="">ทั้งหมด</option>
							</select>
							
						</div>
						<div id="drop_down_organization" class="form-group pull-left span2" style="margin-left: 5px;">
							<select data-toggle="tooltip" title="ช่องทางลงสื่อ" class="input span12 m-b-n" id="year" name="year">
								<option selected value="">Facebook fan page</option>
							</select>
